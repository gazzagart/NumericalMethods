...
public:
/*
 * Constructor to solve simple intial value differential equation, using modified Euler method.
 * @brief Modified Euler method solving differential function
...
*/
    ...
    : EulerMethodDiffs(step,xVal,yVal,xEnd) {} //Call to parent class constuctor
